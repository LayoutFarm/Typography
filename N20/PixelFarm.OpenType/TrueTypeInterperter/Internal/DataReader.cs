...
namespace SharpFont
{
    unsafe sealed class DataReader : IDisposable
    {
        ...
        public byte ReadByte() { return *Read(1); }
        public sbyte ReadSByte() { return *(sbyte*)Read(1); }
        public short ReadInt16() { return *(short*)Read(sizeof(short)); }
        public int ReadInt32() { return *(int*)Read(sizeof(int)); }
        public ushort ReadUInt16() { return *(ushort*)Read(sizeof(ushort)); }
        public uint ReadUInt32() { return *(uint*)Read(sizeof(uint)); }
        public short ReadInt16BE() { return (short)htons(ReadUInt16()); }
        public int ReadInt32BE() { return (int)htonl(ReadUInt32()); }
        public ushort ReadUInt16BE() { return htons(ReadUInt16()); }
        public uint ReadUInt32BE() { return htonl(ReadUInt32()); }
