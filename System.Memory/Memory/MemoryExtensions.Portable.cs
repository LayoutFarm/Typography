...
namespace System
{
    ...
    public static partial class MemoryExtensions
    {
        ...
        public static ReadOnlySpan<char> AsSpan(this string text, int start)
        {
            ...
            return new ReadOnlySpan<char>(Unsafe.As<Pinnable<char>>(text), StringAdjustment.Offset(start * sizeof(char)), text.Length - start);
        }
        ...
        public static ReadOnlySpan<char> AsSpan(this string text, int start, int length)
        {
            ...
            return new ReadOnlySpan<char>(Unsafe.As<Pinnable<char>>(text), StringAdjustment.Offset(start * sizeof(char)), length);
        }
