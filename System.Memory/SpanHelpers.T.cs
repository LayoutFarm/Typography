//https://github.com/dotnet/corefx/blob/d67ea510c68dbce13e735bc18b7356822a0df235/src/Common/src/CoreLib/System/SpanHelpers.T.cs
            ...
            where T : IEquatable<T>
        {
            ...
            while (length >= 8)
            {
                ...
                if (value.Equals(Unsafe.Add(ref searchSpace, index)))
                    goto Found;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(1))))
                    goto Found1;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(2))))
                    goto Found2;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(3))))
                    goto Found3;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(4))))
                    goto Found4;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(5))))
                    goto Found5;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(6))))
                    goto Found6;
                if (value.Equals(Unsafe.Add(ref searchSpace, index.Offset(7))))
                    goto Found7;
            ...
            where T : IEquatable<T>
        {
            ...
            while (length >= 8)
            {
                ...
                if (!Unsafe.Add(ref first, index).Equals(Unsafe.Add(ref second, index)))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(1)).Equals(Unsafe.Add(ref second, index.Offset(1))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(2)).Equals(Unsafe.Add(ref second, index.Offset(2))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(3)).Equals(Unsafe.Add(ref second, index.Offset(3))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(4)).Equals(Unsafe.Add(ref second, index.Offset(4))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(5)).Equals(Unsafe.Add(ref second, index.Offset(5))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(6)).Equals(Unsafe.Add(ref second, index.Offset(6))))
                    goto NotEqual;
                if (!Unsafe.Add(ref first, index.Offset(7)).Equals(Unsafe.Add(ref second, index.Offset(7))))
                    goto NotEqual;
