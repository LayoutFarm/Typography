...
namespace NRasterizer.Tables
{
    ...
    //[LangSysCount] 	Array of LangSysRecords-listed alphabetically by LangSysTag
    //LangSysRecord
    //Type 	Name 	Description
    ...
    class ScriptTable
    {
        ...
        class LangSysTable
        {
            public readonly uint langSysTagIden;
            ...
            public void ReadFrom(BinaryReader reader)
            {
                ...
                //USHORT 	FeatureCount 	Number of FeatureIndex values for this language system-excludes the required feature
                //USHORT 	FeatureIndex[FeatureCount] 	Array of indices into the FeatureList-in arbitrary order
                short lookupOrder = reader.ReadInt16();
                ushort reqFeatureIndex = reader.ReadUInt16();
                ushort featureCount = reader.ReadUInt16();
                featureIndexList = new ushort[featureCount];
                for (int i = 0; i < featureCount; ++i)
                {
                    featureIndexList[i] = reader.ReadUInt16();
                }
            }
#if DEBUG
            public override string ToString()
