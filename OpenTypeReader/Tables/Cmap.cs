    ...
    class Cmap : TableEntry
    {
        ...
        static CharacterMap ReadCharacterMap(CMapEntry entry, BinaryReader input)
        {
            ...
            switch (format)
            {
                ...
                case 4:
                    {
                        return ReadCmapFormat4(input, length);
                    }
            }
        }

        static CharacterMap ReadCmapFormat4(BinaryReader input, ushort cmapLen)
        {
            ...
            long tableStartEndAt = input.BaseStream.Position + cmapLen;
