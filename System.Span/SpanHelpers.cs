//https://github.com/dotnet/corefx/blob/d67ea510c68dbce13e735bc18b7356822a0df235/src/Common/src/CoreLib/System/MemoryExtensions.cs
...
namespace System
{
    internal static partial class SpanHelpers
    {
        ...
        public static unsafe UIntPtr Offset(this UIntPtr ptr, int val)
        {
            ...
            {
                //32-bit path.
                return (UIntPtr)((int)ptr + val);
            }
            else
            {
                //64-bit path.
                return (UIntPtr)((long)ptr + val);
            }
        }
        ...
        public unsafe static void ClearPointerSizedWithoutReferences(ref byte b, UIntPtr byteLength)
        {
            ...
            var i = IntPtr.Zero;
            while (i.LessThanEqual(byteLength.Offset(sizeof(Reg64))))
            {
                Unsafe.As<byte, Reg64>(ref Unsafe.Add<byte>(ref b, i)) = default(Reg64);
                i = i.Offset(sizeof(Reg64));
            }
            if (i.LessThanEqual(byteLength.Offset(-sizeof(Reg32))))
            {
                Unsafe.As<byte, Reg32>(ref Unsafe.Add<byte>(ref b, i)) = default(Reg32);
                i = i.Offset(sizeof(Reg32));
            }
            if (i.LessThanEqual(byteLength.Offset(-sizeof(Reg16))))
            {
                Unsafe.As<byte, Reg16>(ref Unsafe.Add<byte>(ref b, i)) = default(Reg16);
                i = i.Offset(sizeof(Reg16));
            }
            if (i.LessThanEqual(byteLength.Offset(-sizeof(long))))
            {
                Unsafe.As<byte, long>(ref Unsafe.Add<byte>(ref b, i)) = 0;
                i = i.Offset(sizeof(long));
            }
            // JIT: Should elide this if 64-bit
            if (sizeof(IntPtr) == sizeof(int))
            {
                if (i.LessThanEqual(byteLength.Offset(-sizeof(int))))
                {
                    Unsafe.As<byte, int>(ref Unsafe.Add<byte>(ref b, i)) = 0;
                    i = i.Offset(sizeof(int));
                }
            }
        }
        ...
        public static void ClearPointerSizedWithReferences(ref IntPtr ip, UIntPtr pointerSizeLength)
        {
            ...
            var i = IntPtr.Zero;
            var n = IntPtr.Zero;
            while ((n = i.Offset(8)).LessThanEqual(pointerSizeLength))
            {
                Unsafe.Add<IntPtr>(ref ip, i.Offset(0)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(1)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(2)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(3)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(4)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(5)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(6)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(7)) = default(IntPtr);
                i = n;
            }
            if ((n = i.Offset(4)).LessThanEqual(pointerSizeLength))
            {
                Unsafe.Add<IntPtr>(ref ip, i.Offset(0)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(1)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(2)) = default(IntPtr);
            ...
            if ((n = i.Offset(2)).LessThanEqual(pointerSizeLength))
            {
                Unsafe.Add<IntPtr>(ref ip, i.Offset(0)) = default(IntPtr);
                Unsafe.Add<IntPtr>(ref ip, i.Offset(1)) = default(IntPtr);
                i = n;
            }
            if ((i.Offset(1)).LessThanEqual(pointerSizeLength))
            {
