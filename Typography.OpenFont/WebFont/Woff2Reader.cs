...
namespace Typography.WebFont
{
    ...
    public class Woff2Reader
    {
        ...
        //T DecompressAndReadFontTable<T>(BinaryReader reader, Woff2TableDirectory woffTableDir, T table)
        //  where T : TableEntry
        //{
        //    long start = reader.BaseStream.Position;

        //    TableHeader justCreateHeader = new TableHeader(0, 0, (uint)reader.BaseStream.Position, 0);
        //    table.Header = justCreateHeader;
        //    table.LoadDataFrom(reader);
        //    long stop = reader.BaseStream.Position;
        //    long len = stop - start;
        //    if (len < woffTableDir.origLength)
        //    {
        //        reader.BaseStream.Position += (woffTableDir.origLength - len);
        //    }
        //    else if (len == woffTableDir.origLength)
        //    {

        //    }
        //    else
        //    {
        //        reader.BaseStream.Position -= (len - woffTableDir.origLength);
        //    }
        //    return table;
        //}
        //void DecompressFontDataStream(Woff2TableDirectory woff2TableDir, BinaryReader reader)
        //{
        //    //decompress buffer and send data to the reader
        //    //1. check if we want to decompress the table or not

        //    switch (woff2TableDir.PreprocessingTransformation)
        //    {
        //        case 0:
        //            {
        //                //all tables in a font, except for 'glyf' and 'loca' tables,
        //                //transformation version 0 indicates the null transform where the original table data is passed directly
        //                //to the Brotli compressor for inclusion in the compressed data stream. 
        //                switch (woff2TableDir.Name)
        //                {
        //                    case Glyf._N: //"glyf"
        ...
        //                }
        //                if (woff2TableDir.Name == Glyf._N || woff2TableDir.Name == GlyphLocations._N)
        //                {
        //                    //reconstruction glyf , loca
        ...
        //                //The transformed table formats and their associated transformation version numbers are described
        //                //in details in clause 5 of this specification.
        //            }
        //            break;
        //    }
        ...
        //    GlyphLocations glyhLocations = null;
        //    Glyf glyf = null;
        //    MaxProfile maxp = null;
        //    Head head = null;
        //    HorizontalHeader hhea = null;
        //    switch (woff2TableDir.Name)
        //    {
        //        default:
        //            {
        ...
        //            break;
        //        case PrepTable._N:
        //            PrepTable prep = DecompressAndReadFontTable(reader, woff2TableDir, new PrepTable());
        //            break;

        //        case PostTable._N:

        //            reader.BaseStream.Position = woff2TableDir.ExpectedStartAt;
        //            PostTable post = DecompressAndReadFontTable(reader, woff2TableDir, new PostTable());
        //            break;
        //        case HorizontalHeader._N:
        //            hhea = DecompressAndReadFontTable(reader, woff2TableDir, new HorizontalHeader());
        //            break;
        //        case HorizontalMetrics._N:
        //            if (hhea != null && maxp != null)
        //            {
        //                HorizontalMetrics hmtx = DecompressAndReadFontTable(reader, woff2TableDir, new HorizontalMetrics(hhea.HorizontalMetricsCount, maxp.GlyphCount));
        //            }
        //            else
        //            {
        //                //hmtx may be in transformed format
        //                //5.4. Transformed hmtx table format
        //                if (woff2TableDir.transformLength > 0)
        //                {
        //                    reader.BaseStream.Position += woff2TableDir.transformLength;
        //                }
        //                else
        ...
        //            break;
        //        case Gasp._N:
        //            Gasp gasp = DecompressAndReadFontTable(reader, woff2TableDir, new Gasp());
        //            break;
        //        case FpgmTable._N:
        //            FpgmTable fpgmTable = DecompressAndReadFontTable(reader, woff2TableDir, new FpgmTable());
        //            break;
        //        case CvtTable._N:
        //            CvtTable cvt = DecompressAndReadFontTable(reader, woff2TableDir, new CvtTable());
        //            break;
        //        case Cmap._N:
        //            Cmap cmap = DecompressAndReadFontTable(reader, woff2TableDir, new Cmap());
        //            break;
        //        case MaxProfile._N:
        //            maxp = DecompressAndReadFontTable(reader, woff2TableDir, new MaxProfile());
        //            break;

        //        case Head._N:


        //            head = DecompressAndReadFontTable(reader, woff2TableDir, new Head());
        //            break;

        //        case Glyf._N:
        //            if (glyhLocations != null)
        //            {
        //                glyf = DecompressAndReadFontTable(reader, woff2TableDir, new Glyf(glyhLocations));
        //            }
        //            else
        //            {
        //                if (woff2TableDir.PreprocessingTransformation == 0)
        //                {
        //                    long expectedEndPos = reader.BaseStream.Position + woff2TableDir.transformLength;
        //                    //ReconstructGlyfTable(reader, woff2TableDir);
        ...
        //        case GlyphLocations._N: //loca
        //            if (maxp != null && head != null)
        //            {
        //                glyhLocations = DecompressAndReadFontTable(reader, woff2TableDir, new GlyphLocations(maxp.GlyphCount, head.WideGlyphLocations));
        //            }
        //            else
        //            {
        //                if (woff2TableDir.PreprocessingTransformation == 0)
        //                {
        //                    ReconstructGlyphLocationTable(reader, woff2TableDir);
        //                }
        //                else
        //                {
        //                    reader.BaseStream.Position += woff2TableDir.origLength;
        ...
        //        case OS2Table._N:
        //            OS2Table os2 = DecompressAndReadFontTable(reader, woff2TableDir, new OS2Table());
        //            break;

        //        case NameEntry._N:

        //            NameEntry nameEn = DecompressAndReadFontTable(reader, woff2TableDir, new NameEntry());
        //            break;
        ...
        //        case GDEF._N:
        //            GDEF gdef = DecompressAndReadFontTable(reader, woff2TableDir, new GDEF());
        //            break;

        //        case GPOS._N:
        //            GPOS gpos = DecompressAndReadFontTable(reader, woff2TableDir, new GPOS());
        //            break;

        //        case GSUB._N:
        //            GSUB gsub = DecompressAndReadFontTable(reader, woff2TableDir, new GSUB());
        //            break;
        //    }
        //}
