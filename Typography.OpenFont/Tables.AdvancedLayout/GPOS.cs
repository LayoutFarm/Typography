    ...
    public partial class GPOS : GlyphShapingTableEntry
    {
        ...
        public class LookupTable
        {
            ...
            class LkSubTableType4 : LookupSubTable
            {
                ...
                {
                    //count base covate
                    List<ushort> expandedMarks = new List<ushort>(MarkCoverageTable.GetCoveredValueIter());
                    if (expandedMarks.Count != MarkArrayTable.dbugGetAnchorCount())
                    {
                        throw new NotSupportedException();
                    }
                    //--------------------------
                    List<ushort> expandedBase = new List<ushort>(BaseCoverageTable.GetCoveredValueIter());
