...
namespace SharpFont
{
    ...
    public sealed class FontFace
    {
        ...
        public static float ComputePixelSize(float pointSize, int dpi) { return pointSize * dpi / 72; }
        ...
        public Glyph GetGlyph(CodePoint codePoint, float pixelSize)
        {
            ...
            var vtemp = (vmetrics != null) ? new Nullable<MetricsEntry>(vmetrics[glyphIndex]) : null;
            ...
            return new Glyph(pointArray, contourArray, horizontal.Advance * scale);
        }
    ...
    public sealed class Glyph
    {
        ...
        internal Glyph(PointF[] points, int[] contours, float linearHorizontalAdvance)
        {
